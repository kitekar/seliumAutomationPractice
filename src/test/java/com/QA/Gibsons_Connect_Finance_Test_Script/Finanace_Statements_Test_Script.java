...
public class Finanace_Statements_Test_Script extends Generic_Service
{
	LogIn_Base_Page loginbasePage;
	Generic_Service generic;
	Finanace_Statements_Base_Page financestatement;
	
	public Finanace_Statements_Test_Script()
	{
		super();
	}
	...
	public void setUpForLogInToApplication() throws InvalidFormatException, IOException
	{
		...
		financestatement=new 	Finanace_Statements_Base_Page();
	...
	{   
		financestatement.NavigateToFinance();
		financestatement.createStatement();
