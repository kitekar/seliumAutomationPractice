...
public class Bookings_Test_Script extends Generic_Service
{
...
@Test()
public void BookingCalenderReportpage() throws InvalidFormatException, IOException, AWTException

{
bookingspage.NavigateToBookings();
bookingspage.MainPageBookingsReportforStatusAsAll();
bookingspage.MainPageBookingsForyarramGroundspread();
bookingspage.ViewCalenderReportForyarramGroundspread();

	
}

@Test(dependsOnMethods={"BookingCalenderReportpage"})

public void BookingCalenderpage() throws InvalidFormatException, IOException, AWTException

{
bookingspage.NavigateToBookings();
bookingspage.ViewCalenderForAllStatus();
