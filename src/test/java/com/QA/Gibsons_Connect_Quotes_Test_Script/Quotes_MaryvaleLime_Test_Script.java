...
import com.QA.Gibsons_Connect_Quotes.Quotes_LogisticsOrderBase_Page;
import com.QA.Gibsons_Connect_Quotes.Quotes_MaryvaleLime_Base_Page;
import com.relevantcodes.extentreports.ExtentReports;
import com.relevantcodes.extentreports.ExtentTest;

public class Quotes_MaryvaleLime_Test_Script extends Generic_Service
{
	LogIn_Base_Page loginbasePage;
	Generic_Service generic;
	Quotes_MaryvaleLime_Base_Page quotesmaryvalebase;
	
	public Quotes_MaryvaleLime_Test_Script()
	{
		super();
	}
	...
	public void setUpForLogInToApplication() throws InvalidFormatException, IOException {
		...
		quotesmaryvalebase=new Quotes_MaryvaleLime_Base_Page();
	...
	@Test
	public void QuotesMaryvaleOrder() throws InvalidFormatException, IOException, AWTException, InterruptedException

	{ 
		quotesmaryvalebase.navigateToMaryvaleLimequtes();
		quotesmaryvalebase.CreatequotesMaryvaleLImeQuotes();
		quotesmaryvalebase.ConvertMaryvaleLImeQuotesToOrder();
