...
import com.QA.Gibsons_Connect_Quotes.Sales_Log_Base_Page;
import com.relevantcodes.extentreports.ExtentReports;
import com.relevantcodes.extentreports.ExtentTest;

public class Quotes_SalesLog_Test_Scripts extends Generic_Service
{
	LogIn_Base_Page loginbasePage;
	Generic_Service generic;
	Sales_Log_Base_Page salelog;
	
	public Quotes_SalesLog_Test_Scripts()
	{
		super();
	}
	...
	public void setUpForLogInToApplication() throws InvalidFormatException, IOException {
		...
		salelog=new Sales_Log_Base_Page();
	...
	@Test
	public void QuotesSalesLog() throws InvalidFormatException, IOException, AWTException, InterruptedException

	{ 
		salelog.navigateToSalesLog();
	    salelog.LogNewVisit();
		salelog.CaptureTheInformationOfOldexistingLogVisit();
		salelog.CaptureTheInformationOfNewLogVisit();
