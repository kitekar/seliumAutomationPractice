...
import com.QA.Gibsons_Connect_Quotes.Quotes_DarrimanLimeOrder_Base_Page;
import com.relevantcodes.extentreports.ExtentReports;
import com.relevantcodes.extentreports.ExtentTest;

public class Quotes_DarrimaLimeOrder_Test_Script extends Generic_Service
{
	LogIn_Base_Page loginbasePage;
	Generic_Service generic;
	Quotes_DarrimanLimeOrder_Base_Page  quotesdarrimanbase;
	
	public Quotes_DarrimaLimeOrder_Test_Script()
	{
		super();
	}
	...
	public void setUpForLogInToApplication() throws InvalidFormatException, IOException {
		...
		quotesdarrimanbase=new Quotes_DarrimanLimeOrder_Base_Page();
	...
	@Test
	public void QuotesDarrimanOrder() throws InvalidFormatException, IOException, AWTException, InterruptedException

	{ 
		 quotesdarrimanbase.navigateToDarrimanLimequtes();
		 quotesdarrimanbase.CreateDarrimanLImeQuotes();
		 quotesdarrimanbase.ConvertDarrimanLImeQuotesToOrder();
