...
public class Quotes_LogiscticsOrder_Test_Script extends Generic_Service
{
	LogIn_Base_Page loginbasePage;
	Generic_Service generic;
	Quotes_LogisticsOrderBase_Page quoteslogiscticsbase;
	
	public Quotes_LogiscticsOrder_Test_Script()
	{
		super();
	}
	...
	public void setUpForLogInToApplication() throws InvalidFormatException, IOException {
		...
		quoteslogiscticsbase=new Quotes_LogisticsOrderBase_Page();
	...
	@Test
	public void QuotesLogisticsOrder() throws InvalidFormatException, IOException, AWTException, InterruptedException

	{ 
		quoteslogiscticsbase.navigateToquotes();
		quoteslogiscticsbase.createNewLogisticsQuotes();
		quoteslogiscticsbase.ConvertLogisticsQuotesToorder();
