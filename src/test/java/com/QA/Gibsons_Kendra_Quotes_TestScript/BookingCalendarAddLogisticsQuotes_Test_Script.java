...
public class BookingCalendarAddLogisticsQuotes_Test_Script  extends Generic_Service
{
	...
	public BookingCalendarAddLogisticsQuotes_Test_Script()
	{
		super();
	}
	...
	@Test
	public void BookingCalendarAddQuotesLogisctics() throws InvalidFormatException, IOException, InterruptedException
	...
	{   
		...
		quotescalebndar.CreateLogiscticQuotesFromBookingClaendar();
	...
	public void BookingCalendarCancleLogisticsQuote ()throws InvalidFormatException, IOException, InterruptedException
	{
		
	System.out.println("Login Successfully to Gibsons_Kendra");
		
	quotescalebndar.NavigateToBookings();
	quotescalebndar.CancelLogisticsQuotesFromBookingCalendar();
