...
public class BookingCalendarAddMaryvaleQuotes_Test_Script extends Generic_Service
{
	...
	public BookingCalendarAddMaryvaleQuotes_Test_Script()
	{
		super();
	}
	...
	@Test(priority=1)
	public void BookingCalendarAddQuotesMaryvale() throws InvalidFormatException, IOException, InterruptedException
	...
	{   
		...
		quotescalebndar.CreatequotesMaryvaleLimeQuotesFromBookingCalendar();
	...
	@Test(priority=2)
	public void BookingCalendarCancleMaryValeQuote()
	{
		
	System.out.println("Login Successfully to Gibsons_Kendra");
		
	quotescalebndar.NavigateToBookings();
	quotescalebndar.CancelquotesMaryvaleLimeQuotesFromBookingCalendar();
