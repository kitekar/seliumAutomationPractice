...
public class GrounspreadFarmMapHistory_Test_Script  extends Generic_Service
{
	LogIn_Base_Page loginbasePage;
	Generic_Service generic;
	GroundSpreadOders_Base_Page groundspreadbasepage;
	
	public GrounspreadFarmMapHistory_Test_Script()
	{
		super();
	}
	...
	@Test
	public void newValidationofFarm() throws IOException
	{
		
		
		groundspreadbasepage.NavigateToOrders();
		groundspreadbasepage.ValidationForFramhistory();
